<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\Apache\Apache24\htdocs\public/../admin/index\view\index\index.html";i:1496477075;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/static/admin//aboutHui.shtml">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/static/admin//aboutHui.shtml">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v2.4</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="/static/admin/javascript:;">&#xe667;</a>
			<nav class="nav navbar-nav">
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="/static/admin/javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="/static/admin/javascript:;" onclick="article_add('添加资讯','article-add.html')"><i class="Hui-iconfont">&#xe616;</i> 资讯</a></li>
							<li><a href="/static/admin/javascript:;" onclick="picture_add('添加资讯','picture-add.html')"><i class="Hui-iconfont">&#xe613;</i> 图片</a></li>
							<li><a href="/static/admin/javascript:;" onclick="product_add('添加资讯','product-add.html')"><i class="Hui-iconfont">&#xe620;</i> 产品</a></li>
							<li><a href="/static/admin/javascript:;" onclick="member_add('添加用户','member-add.html','','510')"><i class="Hui-iconfont">&#xe60d;</i> 用户</a></li>
						</ul>
					</li>
				</ul>
			</nav>
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li>超级管理员</li>
					<li class="dropDown dropDown_hover"> <a href="/static/admin/#" class="dropDown_A">admin <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="/static/admin/#">个人信息</a></li>
							<li><a href="/static/admin/#">切换账户</a></li>
							<li><a href="/static/admin/#">退出</a></li>
						</ul>
					</li>
					<li id="Hui-msg"> <a href="/static/admin/#" title="消息"><span class="badge badge-danger">1</span><i class="Hui-iconfont" style="font-size:18px">&#xe68a;</i></a> </li>
					<li id="Hui-skin" class="dropDown right dropDown_hover"> <a href="/static/admin/javascript:;" class="dropDown_A" title="换肤"><i class="Hui-iconfont" style="font-size:18px">&#xe62a;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="/static/admin/javascript:;" data-val="default" title="默认（黑色）">默认（黑色）</a></li>
							<li><a href="/static/admin/javascript:;" data-val="blue" title="蓝色">蓝色</a></li>
							<li><a href="/static/admin/javascript:;" data-val="green" title="绿色">绿色</a></li>
							<li><a href="/static/admin/javascript:;" data-val="red" title="红色">红色</a></li>
							<li><a href="/static/admin/javascript:;" data-val="yellow" title="黄色">黄色</a></li>
							<li><a href="/static/admin/javascript:;" data-val="orange" title="绿色">橙色</a></li>
						</ul>
					</li>
				</ul>
			</nav>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo url('goods/product_category'); ?>" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
				
					<li><a _href="/static/admin/product-list.html" data-title="产品管理" href="/static/admin/javascript:void(0)">产品管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
